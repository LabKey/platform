...
public class Certificate {
	 ...
	 */
 	public void loadCertificate(String certificate) throws CertificateException {
		...
		ByteArrayInputStream bais = new ByteArrayInputStream(Base64.decodeBase64(certificate.getBytes(StandardCharsets.UTF_8)));
	 ...
	 * @throws java.security.cert.CertificateException In case it can't load the certificate.
	 */
