...
%>
<%
    HttpView<PipelineTriggerForm> me = HttpView.currentView();
...
%>
    <div class="alert alert-info">
        ...
        <br>
        <p><a class="alert-link" href="https://www.labkey.com/products-services/labkey-server/#editions" target="_blank" rel="noopener noreferrer">Go Premium <i class="fa fa-external-link"></i></a></p>
    </div>
<%
    } else {
%>
