 ...
 */
/* package */ class TaskPipelineCacheHandlerOld implements ModuleResourceCacheHandler<String, TaskPipeline>
{
    private static final Logger LOG = Logger.getLogger(TaskPipelineCacheHandlerOld.class);
