 ...
 * Date: 1/6/14
 */
/* package */ class TaskFactoryCacheHandlerOld implements ModuleResourceCacheHandler<String, TaskFactory>
{
    private static final Logger LOG = Logger.getLogger(TaskFactoryCacheHandlerOld.class);
