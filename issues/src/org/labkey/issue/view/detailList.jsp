...
<table><tr>
    <td><%= textLink("new " + names.singularName.toLowerCase(), IssuesController.issueURL(c, IssuesController.InsertAction.class).addParameter(DataRegion.LAST_FILTER_PARAM, "true"))%></td>
