...
-- Use Java code to populate sequences, initializing each current value to the maximum list ID in each folder
SELECT core.executeJavaUpgradeCode('createListSequences');
