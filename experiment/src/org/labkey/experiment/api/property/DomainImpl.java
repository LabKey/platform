...
public class DomainImpl implements Domain
{
    ...
    public void save(User user, boolean allowAddBaseProperty) throws ChangePropertyDescriptorException
    {
        ...
        try (DbScope.Transaction transaction = scope.ensureTransaction(domainLock))
        {
            ...
            transaction.addCommitTask(OntologyManager::clearCaches, DbScope.CommitTaskOption.IMMEDIATE, DbScope.CommitTaskOption.POSTCOMMIT, DbScope.CommitTaskOption.POSTROLLBACK);
            transaction.commit();
        }
    }
