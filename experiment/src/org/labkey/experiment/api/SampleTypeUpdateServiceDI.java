...
public class SampleTypeUpdateServiceDI extends DefaultQueryUpdateService
{
    ...
    protected Map<String, Object> _update(User user, Container c, Map<String, Object> row, Map<String, Object> oldRow, Object[] keys) throws SQLException, ValidationException
    {
        ...
        boolean oldAllowsOp = SampleQCStateService.get().isOperationPermitted(oldStatus, SampleTypeService.SampleOperations.EditMetadata);
        ...
        boolean newAllowsOp = SampleQCStateService.get().isOperationPermitted(newStatus, SampleTypeService.SampleOperations.EditMetadata);
            ...
            throws QueryUpdateServiceException, SQLException, InvalidKeyException, BatchValidationException
    {
        ...
        else
        {
            ...
            for (Map<String, Object> k : keys)
            {
                ...
                if (!SampleQCStateService.get().isOperationPermitted(getContainer(), (Integer) map.get(ExpMaterialTable.Column.SampleState.name()), SampleTypeService.SampleOperations.Delete))
                {
