...
//            ss.addSearchCategory(OntologyManager.conceptCategory);
        ...
        if (null != svc)
        {
            svc.registerUsageMetrics(MODULE_NAME, () -> {
                ...
                results.put("scannableColumnCount", new SqlSelector(ExperimentService.get().getSchema(), "SELECT COUNT(*) FROM exp.propertydescriptor WHERE scannable").getObject(Long.class));
