...
public class ExperimentModule extends SpringModule
{
    ...
    protected void init()
    {
        ...
        {
            OptionalFeatureService.get().addExperimentalFeatureFlag(SAMPLE_FILES_TABLE, "Manage Stale Sample Files",
                    "Allow 'Manage Sample Files' to view sample files that are no longer referenced by samples", false);
