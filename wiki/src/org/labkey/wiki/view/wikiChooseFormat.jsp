...
<form action="editWiki.view" method="GET" id="wiki-format-form">
    ...
    <input type="radio" name="format" value="<%=WikiRendererType.HTML.name()%>" id="rbHtml" checked="1"><label for="rbHtml"><b>HTML Format&nbsp;&nbsp;&nbsp;&nbsp;</b></label>
    <blockquote>
    ...
    <input type="radio" name="format" value="<%=WikiRendererType.RADEOX.name()%>" id="rbRadeox"><label for="rbRadeox"><b>Wiki Format&nbsp;&nbsp;&nbsp;&nbsp;</b></label>
    <blockquote>
        Pages in Wiki Format are authored in plain text using simple markup characters to indicate bold,
        italics, headings, hyperlinks, bulleted or numbered lists, tables, etc. The specific wiki markup
        dialect is covered on the
        <a href="https://www.labkey.org/wiki/home/Documentation/page.view?name=wikiSyntax">Wiki Syntax</a>
        help page.
    </blockquote>
    <input type="radio" name="format" value="<%=WikiRendererType.TEXT_WITH_LINKS.name()%>" id="rbText"><label for="rbText"><b>Plain Text Format</b></label>
    <blockquote>
