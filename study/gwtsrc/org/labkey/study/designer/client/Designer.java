...
public class Designer implements EntryPoint
{
    ...
    {
        RootPanel.get("org.labkey.study.designer.Designer-Root").add(new Label("Loading..."));
    ...
    private void showStudy(GWTStudyDefinition def)
    {
        ...
        RootPanel.get("org.labkey.study.designer.Designer-Root").clear();
        RootPanel.get("org.labkey.study.designer.Designer-Root").add(mainPanel);
        setDirty(false);
    }
