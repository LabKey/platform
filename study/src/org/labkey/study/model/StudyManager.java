...
*/
    ...
    public void clearParticipantCohorts(User user, Study study) throws SQLException
    {
        ...
        Table.execute(StudySchema.getInstance().getSchema(),
                "UPDATE study.Participant SET InitialCohortId = NULL, CurrentCohortId = NULL WHERE Container = ?", new Object[] { study.getContainer().getId() });
        ...
        Table.execute(StudySchema.getInstance().getSchema(),
                "UPDATE study.ParticipantVisit SET CohortId = NULL WHERE Container = ?", new Object[] { study.getContainer().getId() });
