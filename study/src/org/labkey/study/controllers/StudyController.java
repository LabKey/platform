...
public class StudyController extends BaseStudyController
{
    ...
    public static class StudyUrlsImpl implements StudyUrls
    {
        ...
        {
            return new ActionURL(DatasetAction.class, container).addParameter(Dataset.DATASET_KEY, datasetId);
        }
    ...
    public static class ExpandStateNotifyAction extends SimpleViewAction
    {
        ...
        public ModelAndView getView(Object o, BindException errors)
        {
            ...
            final int datasetId = NumberUtils.toInt(url.getParameter(Dataset.DATASET_KEY), -1);
...
//                Portal.addViewToRegion(template, WebPartFactory.LOCATION_BODY, (HttpView)v);
    ...
    public class ImportAction extends AbstractQueryImportAction<ImportDatasetForm>
    {
        ...
        @Override
        protected int importData(DataLoader dl, FileStream file, String originalName, BatchValidationException errors, @Nullable AuditBehaviorType auditBehaviorType, @Nullable  TransactionAuditProvider.TransactionAuditEvent auditEvent, @Nullable String auditUserComment)
        {
            if (null == PipelineService.get().findPipelineRoot(getContainer()))
            {
        ...
        public void addNavTrail(NavTree root)
        {
            ...
            ActionURL datasetURL = new ActionURL(DatasetAction.class, getContainer()).
                    addParameter(Dataset.DATASET_KEY, _form.getDatasetId());
                              ...
                              final UserSchema querySchema, final Dataset def)
    {
        ...
        base.addParameter(Dataset.DATASET_KEY, Integer.toString(def.getDatasetId()));
    ...
    public class DefaultDatasetReportAction extends SimpleRedirectAction
    {
        ...
        public ActionURL getRedirectURL(Object o)
        {
            ...
            Object unparsedDatasetId = context.get(Dataset.DATASET_KEY);
    ...
    public static class CreateSnapshotAction extends FormViewAction<StudySnapshotForm>
    {
        ...
        private Dataset createDataset(StudySnapshotForm form, BindException errors) throws Exception
        {
            ...
            if (dsDef == null)
            {
                ...
                int datasetId = NumberUtils.toInt(getViewContext().getActionURL().getParameter(Dataset.DATASET_KEY), -1);
