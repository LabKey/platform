...
public class CreateAncillaryStudyAction extends MutatingApiAction<EmphasisStudyDefinition>
{
    ...
    public ApiResponse execute(EmphasisStudyDefinition form, BindException errors) throws Exception
    {
        ...
        if (newStudy != null)
        {
            ...
            CreateAncillaryStudyPipelineJob job = new CreateAncillaryStudyPipelineJob(getViewContext(), root, form, _destFolderCreated);
    ...
    private static class CreateAncillaryStudyPipelineJob extends PipelineJob
    {
        private EmphasisStudyDefinition _form;
        private boolean _destFolderCreated;

        private transient Container _dstContainer;
        private transient StudyImpl _sourceStudy;
        ...
        public void run()
        {
            ...
            try
            {
                BindException errors = new NullSafeBindException(this, "ancillaryStudy");
                ...
                if (newStudy != null)
                {
                    ...
                    exportFromParentStudy(_form, ctx, vf);
                    importToDestinationStudy(_form, errors, newStudy, vf);

                    // copy participants
                    exportParticipantGroups(_form, newStudy, ctx, vf);
        ...
        private void exportFromParentStudy(EmphasisStudyDefinition form, FolderExportContext ctx, VirtualFile vf) throws Exception
        {
        ...
        private void importDatasetData(ViewContext context, EmphasisStudyDefinition form, StudyImpl newStudy, VirtualFile vf, BindException errors) throws Exception
        {
            User user = getUser();
        ...
        private void exportParticipantGroups(EmphasisStudyDefinition form, StudyImpl newStudy, FolderExportContext ctx, VirtualFile vf) throws Exception
        {
