...
<%
        List<ProductImpl> immunogens = study.getStudyProducts(user, "Immunogen", null);
        ...
        {
%>
            <tr><td>This section describes the immunogens and adjuvants evaluated in the study.</td></tr>
            <tr><td>
...
<%
        List<ProductImpl> adjuvants = study.getStudyProducts(user, "Adjuvant", null);
        if (adjuvants.size() == 0)
        {
        ...
        Ext4.each(Ext4.dom.Query.select('.immunogen-hiv-antigen'), function(div){
            LABKEY.Query.selectRows({
                ...
                success: function(data) {
                    div.innerHTML = new LABKEY.ext4.ImmunogensGridHelper().getHIVAntigenDisplay(data.rows);
                }
            })
        });
