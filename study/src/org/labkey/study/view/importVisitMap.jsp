...
<labkey:errors/>
You can import a visit map in XML format to quickly configure a study. An example visit map is available in the documentation topic: <%=helpLink("importVisitMap", "Import Visit Map")%>
