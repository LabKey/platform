...
You can also reload a study from a folder archive that contains study objects. A folder archive is a .folder.zip file.
...
be created using a standard template. You can also import a study from a folder archive that contains study objects. A folder
archive is a .folder.zip file.
<%
    }
%>
...
<tr><td>To <%=lowerCaseVerb%> a study from a zip archive on your local machine (for example, a study that you have exported and saved
        to your local hard drive), browse to a .study.zip or a .folder.zip file, open it, and click the "<%=initialCapVerb%> Study From Local Zip Archive" button below.</td></tr>
...
<tr><td class="labkey-title-area-line"></td></tr>
    <tr><td>To <%=lowerCaseVerb%> a study from a server-accessible archive, click the "<%=initialCapVerb%> Study Using Pipeline"
            button below, navigate to a .study.zip archive, a .folder.zip archive, or a study.xml file, and click the "<%=initialCapVerb%> Study" button.<%
