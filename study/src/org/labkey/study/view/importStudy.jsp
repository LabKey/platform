...
<p>
    <span style='font-style: italic;'>Notice: study archives have been deprecated in favor of folder archives. Use the following page to import a folder archive:</span>
    <%= textLink("Import Folder Archive", urlProvider(AdminUrls.class).getImportFolderURL(c)) %>
</p>
<%
    }
%>
...
<tr><td>To <%=lowerCaseVerb%> a study from a zip archive on your local machine (for example, a study that you have exported and saved
        to your local hard drive), browse to a .study.zip archive, open it, and click the "<%=initialCapVerb%> Study From Local Zip Archive" button below.</td></tr>
