...
<tr><td class="labkey-announcement-title" align=left><span><%=initialCapVerb%> From Local Zip Archive</span></td></tr>
...
<tr><td>To <%=lowerCaseVerb%> a study from a zip archive on your local machine (for example, a study that you have exported and saved
        to your local hard drive), browse to a .study.zip file, open it, and click the "<%=initialCapVerb%> Local Zip Archive" button below.</td></tr>
<tr><td><input type="file" name="studyZip" size="50"></td></tr>
<tr>
    <td><%=PageFlowUtil.generateSubmitButton(initialCapVerb + " Local Zip Archive")%></td>
</tr>
<tr>
    <td>&nbsp;</td>
</tr>
<tr><td class="labkey-announcement-title" align=left><span><%=initialCapVerb%> From Server-Accessible Archive</span></td></tr>
<tr><td class="labkey-title-area-line"><img height=1 width=1 src="/labkey/_.gif"></td></tr>
    <tr><td>To <%=lowerCaseVerb%> a study from a server-accessible archive, click the "<%=initialCapVerb%> Server Archive Using Pipeline"
...
<tr>
    <td><%=PageFlowUtil.generateButton(initialCapVerb + " Server Archive Using Pipeline", urlProvider(PipelineUrls.class).urlBrowse(c, "pipeline"))%></td>
</tr>
</table>
</form>
