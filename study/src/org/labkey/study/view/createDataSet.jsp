...
<%
    JspView<OldStudyController.DataSetForm> me = (JspView<OldStudyController.DataSetForm>) HttpView.currentView();
    OldStudyController.DataSetForm form = me.getModelBean();
