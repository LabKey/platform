...
%>
    ...
    <table class="labkey-tab-strip">
        <tr>
            ...
            <td class=<%=SecurityController.TAB_REPORT.equals(currentTab) ? "labkey-nav-tab-selected" : "labkey-nav-tab-inactive"%>><a <%=SecurityController.TAB_REPORT.equals(currentTab) ? "" : "href=\"" + url.replaceParameter("tabId", SecurityController.TAB_REPORT) + "\""%>>Permissions&nbsp;</a></td>
            <td class=<%=SecurityController.TAB_STUDY.equals(currentTab) ? "labkey-nav-tab-selected" : "labkey-nav-tab-inactive"%>><a <%=SecurityController.TAB_STUDY.equals(currentTab) ? "" : "href=\"" + url.replaceParameter("tabId", SecurityController.TAB_STUDY) + "\""%>>Study&nbsp;Security&nbsp;</a></td>
