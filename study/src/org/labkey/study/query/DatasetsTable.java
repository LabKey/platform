    ...
    public DatasetsTable(StudyQuerySchema schema, ContainerFilter cf)
    {
        ...
        ExprColumn result = new ExprColumn(this, "QuerySnapshot", new SQLFragment("~~PLACEHOLDER~~"), JdbcType.BOOLEAN)
        {
            ...
            public SQLFragment getValueSql(String tableAlias)
            {
                ...
                existsSql.append(" WHERE qs.").append(getSqlDialect().makeLegalIdentifier("schema")).append(" = ").appendValue(StudySchema.getInstance().getSchemaName()).append(" AND ").append(tableAlias).append(".Name = qs.Name AND ");
