 ...
 * Time: 3:10:37 PM
 */
public class DatasetDefinitionWriter implements InternalStudyWriter
{
    private static final Logger LOG = LogManager.getLogger(DatasetDefinitionWriter.class);
    ...
    public void write(StudyImpl study, StudyExportContext ctx, VirtualFile root) throws IOException, ImportException
    {
        ...
        datasetsXml.setFile(DatasetDefinitionWriter.MANIFEST_FILENAME);
