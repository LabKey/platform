...
public class StudyDataspaceTest extends StudyBaseTest
{
    ...
    protected void doVerifySteps()
    {
        ...
        rowValueMap.put("Lab", Pair.of(1, "Buffalo1"));
        rowValueMap.put("Product", Pair.of(1, "gakkon"));
        rowValueMap.put("Treatment", Pair.of(1, "Placebo"));
        rowValueMap.put("CD4", Pair.of(1, "520"));
        rowValueMap.put("Treatment By", Pair.of(1, "Frankie Lee"));
        ...
        rowValueMap.put("Lab", Pair.of(0, "Buffalo1"));
        rowValueMap.put("Product", Pair.of(0, "gp145"));
        rowValueMap.put("Treatment", Pair.of(0, "VRC-HIVADV014-00-VP"));
        rowValueMap.put("CD4", Pair.of(0, "543"));
        rowValueMap.put("Treatment By", Pair.of(0, "Frankie Lee"));
