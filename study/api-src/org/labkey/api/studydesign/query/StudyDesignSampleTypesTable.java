...
{
    public StudyDesignSampleTypesTable(StudyDesignQuerySchema schema, ContainerFilter filter)
    {
        super(schema, StudyDesignSchema.getInstance().getTableInfoStudyDesignSampleTypes(), filter);
