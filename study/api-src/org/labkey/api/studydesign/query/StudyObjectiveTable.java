 ...
 */
public class StudyObjectiveTable extends StudyDesignBaseTable
{
    public StudyObjectiveTable(StudyDesignQuerySchema schema, ContainerFilter cf)
    {
        super(schema, StudyDesignSchema.getInstance().getTableInfoObjective(), cf, true);
