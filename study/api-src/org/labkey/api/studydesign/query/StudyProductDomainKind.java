...
public class StudyProductDomainKind extends AbstractStudyDesignDomainKind
{
    ...
    static {
        ...
        baseFields.add(AbstractStudyDesignDomainKind.createFieldSpec("RowId", JdbcType.INTEGER, true, true));
        baseFields.add(AbstractStudyDesignDomainKind.createFieldSpec("Label", JdbcType.VARCHAR).setSize(200).setNullable(false));
        baseFields.add(AbstractStudyDesignDomainKind.createFieldSpec("Role", JdbcType.VARCHAR).setSize(200));
        baseFields.add(AbstractStudyDesignDomainKind.createFieldSpec("Type", JdbcType.VARCHAR).setSize(200));
    ...
    {
        super(StudyDesignQuerySchema.PRODUCT_TABLE_NAME, _baseFields);
    }
