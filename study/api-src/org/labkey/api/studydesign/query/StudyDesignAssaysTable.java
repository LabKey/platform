...
{
    public StudyDesignAssaysTable(StudyDesignQuerySchema schema, ContainerFilter filter)
    {
        super(schema, StudyDesignSchema.getInstance().getTableInfoStudyDesignAssays(), filter);
