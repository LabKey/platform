...
{
    public StudyDesignLabsTable(StudyDesignQuerySchema schema, ContainerFilter filter)
    {
        super(schema, StudyDesignSchema.getInstance().getTableInfoStudyDesignLabs(), filter);
