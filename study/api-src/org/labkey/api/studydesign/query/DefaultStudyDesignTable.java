...
public class DefaultStudyDesignTable<SchemaType extends StudyDesignQuerySchema> extends FilteredTable<SchemaType>
{
    ...
    public static <SchemaType extends StudyDesignQuerySchema> DefaultStudyDesignTable create(Domain domain, SchemaType schema, @Nullable ContainerFilter containerFilter)
    {
    ...
    public void deleteData(Container c, User user)
    {
        ...
        DbScope scope =  StudyDesignSchema.getInstance().getSchema().getScope();
