...
public class StudyTreatmentTable extends DefaultStudyDesignTable
{
    ...
    public static StudyTreatmentTable create(Domain domain, StudyDesignQuerySchema schema, @Nullable ContainerFilter filter)
    {
    ...
    private StudyTreatmentTable(Domain domain, TableInfo storageTableInfo, StudyDesignQuerySchema schema, @Nullable ContainerFilter filter)
    {
        super(domain, storageTableInfo, schema, filter);

        setName(StudyDesignQuerySchema.TREATMENT_TABLE_NAME);
