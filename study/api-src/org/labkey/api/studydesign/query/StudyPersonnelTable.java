 ...
 */
public class StudyPersonnelTable extends DefaultStudyDesignTable<StudyDesignQuerySchema>
{
    ...
    public static StudyPersonnelTable create(Domain domain, StudyDesignQuerySchema schema, @Nullable ContainerFilter containerFilter)
    {
    ...
    private StudyPersonnelTable(Domain domain, TableInfo storageTableInfo, StudyDesignQuerySchema schema, @Nullable ContainerFilter containerFilter)
    {
        super(domain, storageTableInfo, schema, containerFilter);

        setName(StudyDesignQuerySchema.PERSONNEL_TABLE_NAME);
