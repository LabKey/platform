...
{
    public DoseAndRouteTable(StudyDesignQuerySchema schema, ContainerFilter filter)
    {
        super(schema, StudyDesignSchema.getInstance().getTableInfoDoseAndRoute(), filter);
