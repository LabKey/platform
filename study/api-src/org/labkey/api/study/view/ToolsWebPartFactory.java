...
package org.labkey.api.study.view;
 ...
 */
public abstract class ToolsWebPartFactory extends BaseWebPartFactory
{
    protected ToolsWebPartFactory(String name, @NotNull String defaultLocation, String... additionalLocations)
    {
