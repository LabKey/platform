 ...
 * Date: Mar 14, 2012
 */
public abstract class BaseSpecimenPivotTable extends FilteredTable<UserSchema>
{
    ...
    public BaseSpecimenPivotTable(final TableInfo tinfo, final UserSchema schema)
    {
        super(tinfo, schema);
