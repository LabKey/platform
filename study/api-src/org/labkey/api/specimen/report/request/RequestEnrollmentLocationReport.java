...
import org.labkey.api.specimen.report.SpecimenTypeVisitReport;
import org.labkey.api.specimen.report.SpecimenVisitReportParameters;
...
public class RequestEnrollmentLocationReport extends SpecimenTypeVisitReport
{
    ...
    public RequestEnrollmentLocationReport(String titlePrefix, SimpleFilter filter, SpecimenVisitReportParameters parameters,
                                           List<? extends Visit> visits, int locationId, boolean completedRequestsOnly)
    {
