...
public abstract class SpecimenVisitReport<CELLDATA extends SpecimenReportCellData>
{
    ...
    protected String getFilterQueryString(Visit visit, CELLDATA summary)
    {
        ...
        {
            ParticipantGroup filterGroup = ParticipantGroupService.get().getParticipantGroup(getContainer(), getUser(), _parameters.getParticipantGroupFilter());
            if (filterGroup != null)
    ...
    protected SpecimenTypeLevel getTypeLevelEnum()
    {
