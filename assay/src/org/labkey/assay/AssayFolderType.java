...
public class AssayFolderType extends MultiPortalFolderType
{
    ...
    AssayFolderType(Module module)
    {
        super(NAME,
                "Design and manage specialized assays. " +
                "Analyze, visualize and share results.",
                Collections.emptyList(),
                Arrays.asList(AssayModule.assayListWebPartFactory.createWebPart()),
                getActiveModulesForOwnedFolder(module),
                module);
    }

    protected static Set<Module> getActiveModulesForOwnedFolder(Module module)
    {
