...
<form action="" method="post">
    <table cellpadding="0" class="normal">
        ...
        <tr><td>&nbsp;</td></tr>
        <tr><td>Manual Refresh</td><td><input disabled="true" checked type="radio" name="manualRefresh"></td></tr>
        <tr><td>Automatic Refresh</td><td><input disabled="true" type="radio" name="automaticRefresh"></td></tr>
