...
public abstract class AutoGeneratedCustomView implements CustomView
{
    ...
    public AutoGeneratedCustomView(QueryDefinition queryDef, String name)
    {
        _queryDef = queryDef;
        _name = name;
    }
    ...
    public List<FieldKey> getColumns()
    {
        if (_columns == null)
        {
            _columns = new ArrayList<FieldKey>();
            _columns = getFieldKeysToShow(_queryDef.getTable(new ArrayList<QueryException>(), true));
        }
        return _columns;
    }
    ...
    {
        List<Map.Entry<FieldKey, Map<ColumnProperty, String>>> result = new ArrayList<Map.Entry<FieldKey, Map<ColumnProperty, String>>>();
        for (FieldKey fieldKey : getColumns())
        {
            result.add(new Pair<FieldKey, Map<ColumnProperty, String>>(fieldKey, Collections.<ColumnProperty, String>emptyMap()));
        }
        return result;
    }
    ...
    {
        return ContainerFilter.CURRENT.getType().name();
    }
