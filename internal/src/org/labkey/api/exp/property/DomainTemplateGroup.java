...
public class DomainTemplateGroup
{
            ...
            return (key, argument) -> {
                ...
                try (InputStream xmlStream = resource.getInputStream())
                {
                    if (null != xmlStream)
                    {
                        ...
                        return create(module.getName(), groupName, doc);
                    }
                }
                ...
                {
                    LOG.error("Error parsing domain template '" + resource + "'", e);
                }
    ...
    private static DomainTemplateGroup create(String moduleName, String groupName, TemplatesDocument doc)
    {
        ...
        {
            DomainTemplate t = DomainTemplate.create(moduleName, groupName, template);
            if (t != null)
                templates.add(t);
        }

        return new DomainTemplateGroup(moduleName, groupName, Collections.unmodifiableList(templates));
    }
    ...
    {
        Map<String, DomainTemplate> templates = new HashMap<>();
    ...
    private List<DomainTemplate> _templates;

    private DomainTemplateGroup(String moduleName, String groupName, List<DomainTemplate> templates)
    {
