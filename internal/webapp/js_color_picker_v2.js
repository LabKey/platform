...
************************************************************************************************************/
	...
	var form_widget_amount_slider_handle = LABKEY.imagePath + '/slider_handle.gif';
		...
		do{			
			if(subDiv.tagName=='DIV' && subDiv.className!='colorPickerCloseButton'){
				if(subDiv==thisObj){
					...
					img.src = LABKEY.imagePath + "/tab_right_active.gif";
					...
					img.src = LABKEY.imagePath + "/tab_right_inactive.gif";
					if(activeColorDiv)
	...
	function createColorPickerTopRow(inputObj){
		...
		for(var no=0;no<tabs.length;no++){
			...
			tabImg.src = LABKEY.imagePath + "/tab_right_" + suffix + ".gif";
	...
	{
        var color = document.getElementById('js_color_picker_color_code').value;
        if (color.substring(0, 1) == '#')
        {
            color = color.substring(1)
        }
