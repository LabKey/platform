...
class WritableIndexImpl extends SearchableIndex implements WritableIndex
{
    private static final Logger _log = Logger.getLogger(WritableIndexImpl.class);
    ...
    WritableIndexImpl(File indexPath, Analyzer analyzer) throws IOException
    {
