    ...
    getActions : function() {
        if (!this.actions) {
            ...
            this.actions.createDirectory = Ext4.create('File.panel.Action', {
                ...
                html: '<span class="fa-stack fa-1x"><span class="fa fa-folder-o fa-stack-2x"></span><span class="fa fa-plus-circle fa-stack-1x labkey-fa-plus-circle-folder"></span></span>',
            ...
            this.actions.upload = Ext4.create('File.panel.Action', {
                ...
                itemId: 'upload',
                html: '<span class="fa-stack fa-1x"><span class="fa fa-file-o fa-stack-2x"></span><span class="fa fa-arrow-circle-o-up fa-stack-1x labkey-fa-upload-files"></span></span><span class="labkey-fa-upload-files-text">Upload Files</span>',
                enableToggle: true,
