 ...
 */
/**
 * @class LABKEY.Ext.ux.ToolbarReorderer
 ...
 */
Ext.namespace('LABKEY', 'LABKEY.ext.ux');

LABKEY.ext.ux.ToolbarReorderer = Ext.extend(LABKEY.ext.ux.Reorderer, {
    /**
    ...
    init: function(toolbar) {
        ...
        LABKEY.ext.ux.ToolbarReorderer.superclass.init.apply(this, arguments);
    },
