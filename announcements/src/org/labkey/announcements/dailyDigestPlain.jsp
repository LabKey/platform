...
%><%=text(ann.getCreatedByName(includeGroups, HttpView.currentContext().getUser()))%><% if (null == ann.getParent()) { %> created this <%=text(conversationName)%><% } else { %> responded<% } %> at <%=text(DateUtil.formatDateTime(c, ann.getCreated()))%><%
