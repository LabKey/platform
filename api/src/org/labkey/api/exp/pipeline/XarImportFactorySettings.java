 ...
 */
public class XarImportFactorySettings extends AbstractTaskFactorySettings
{
    private String _inputExt;

    public XarImportFactorySettings(String name)
    {
        super(new TaskId(XarImportTaskId.class, name));
    }

    public TaskId getCloneId()
    {
        return new TaskId(XarImportTaskId.class);
    }
