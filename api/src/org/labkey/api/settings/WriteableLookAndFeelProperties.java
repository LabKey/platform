...
public class WriteableLookAndFeelProperties extends LookAndFeelProperties
{
    ...
    {
        storeStringValue(CUSTOMMENU_SCHEMA, schemaName);
    }

    public void setQueryName(String queryName)
    {
        storeStringValue(CUSTOMMENU_QUERY, queryName);
    }

    public void setFolderName(String folderName)
    {
        storeStringValue(CUSTOMMENU_FOLDER, folderName);
    }

    public void setViewName(String viewName)
    {
        storeStringValue(CUSTOMMENU_VIEW, viewName);
    }

    public void setColumnName(String columnName)
    {
        storeStringValue(CUSTOMMENU_COLUMN, columnName);
    }

    public void setTitle(String title)
    {
        storeStringValue(CUSTOMMENU_TITLE, title);
    }

    public void setUrlTop(String urlTop)
    {
        storeStringValue(CUSTOMMENU_URLTOP, urlTop);
    }

    public void setUrlBottom(String urlBottom)
    {
        storeStringValue(CUSTOMMENU_URLBOTTOM, urlBottom);
    }

    public void setRootFolder(String rootFolder)
    {
        storeStringValue(CUSTOMMENU_ROOTFOLDER, rootFolder);
    }

    public void setFolderTypes(String folderTypes)
    {
        storeStringValue(CUSTOMMENU_FOLDERTYPES, folderTypes);
    }

    public void setChoiceListQuery(boolean choiceListQuery)
    {
        storeBooleanValue(CUSTOMMENU_CHOICELISTQUERY, choiceListQuery);
    }

    public void setIncludeAllDescendants(boolean includeAllDescendants)
    {
        storeBooleanValue(CUSTOMMENU_INCLUDEALLDESCENDANTS, includeAllDescendants);
    }
}
