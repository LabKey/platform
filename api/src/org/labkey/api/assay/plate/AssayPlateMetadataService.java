...
public interface AssayPlateMetadataService
{
    ...
    List<Map<String, Object>> parsePlateGrids(Container container, AssayProvider provider, ExpProtocol protocol, Integer plateSetId, File dataFile) throws ExperimentException;
