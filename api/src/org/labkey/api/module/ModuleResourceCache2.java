 ...
 * Date: 12/26/13
 */
public final class ModuleResourceCache2<V>
{
    private static final Logger LOG = Logger.getLogger(ModuleResourceCache2.class);
...
//        ensureListeners(root);  // TODO: Enable this to ensure file listeners along the root... except that this seems to deadlock. Maybe push this into CacheLoader.load() above?
    ...
    private static class FileListenerResource extends ResourceWrapper
    {
        ...
        public FileListenerResource(Resource resource, Module module, ModuleResourceCache2 cache)
        {
            super(resource);
            _module = module;
            _cache = cache;
