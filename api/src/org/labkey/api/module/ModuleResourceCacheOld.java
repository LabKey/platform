 ...
 */
@Deprecated
public final class ModuleResourceCacheOld<T>
{
    private static final Logger LOG = Logger.getLogger(ModuleResourceCacheOld.class);

    private final BlockingStringKeyCache<Object> _cache;
    private final ModuleResourceCacheHandlerOld<String, T> _handler;
    private final ModuleResourceDirectory _directory;

    ModuleResourceCacheOld(ModuleResourceDirectory directory, String description, ModuleResourceCacheHandlerOld<String, T> handler)
    {
