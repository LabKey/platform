...
public class ModuleHtmlViewDefinition
{
    ...
    protected void calculatePermissions() throws ViewDefinitionException
    {
        if (_viewDef.isSetPermissionClasses() || _viewDef.isSetRequiresPermissions())
        {
            ...
            if (_viewDef.isSetPermissionClasses())
                addPermissionClasses(_viewDef.getPermissionClasses());

            if (_viewDef.isSetRequiresPermissions())
                addPermissionClasses(_viewDef.getRequiresPermissions());
        }
    ...
    private void addPermissionClasses(PermissionClassListType permClassList) throws ViewDefinitionException
    {
    ...
    public static class TestCase extends Assert
    {
        ...
        public void testPermissions()
        {
            ...
            // Old-style ACLs are no longer supported
            testBadPermissions("<permissions><permission name=\"none\"/></permissions>", "Document does not conform to its XML schema");
            testBadPermissions("<permissions><permission name=\"login\"/></permissions>", "Document does not conform to its XML schema");
            testBadPermissions("<permissions><permission name=\"insert\"/></permissions>", "Document does not conform to its XML schema");
            testBadPermissions("<permissions><permission name=\"admin\"/></permissions>", "Document does not conform to its XML schema");
