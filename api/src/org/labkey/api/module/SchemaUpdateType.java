...
public enum SchemaUpdateType
{
    Before
    {
        @Nullable
        @Override
        public SqlScript getScript(SqlScriptProvider provider, DbSchema schema)
        {
    ...
    public abstract @Nullable SqlScript getScript(SqlScriptProvider provider, DbSchema schema);
}
