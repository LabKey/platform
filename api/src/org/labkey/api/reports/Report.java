...
public interface Report extends AttachmentParent, ThumbnailProvider
{
     ...
     */
    void serialize(ImportExportContext context, VirtualFile dir, String filename) throws IOException;
     ...
     */
    void serializeToFolder(ImportExportContext context, VirtualFile directory) throws IOException;
    ...
    enum renderParam implements SafeToRenderEnum
    {
        reportWebPart,
        reportId,
        reportSessionId,
