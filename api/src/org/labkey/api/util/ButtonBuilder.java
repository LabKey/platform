...
public class ButtonBuilder extends DisplayElementBuilder<ButtonBuilder.Button, ButtonBuilder>
{
    ...
    {
        if (primary)
            this.typeCls = Button.PRIMARY_CLS;
     ...
     */
    public static class Button extends DisplayElement implements HasHtmlString, SafeToRender
    {
        // Button constants
        ...
        public HtmlString getHtmlString()
        {
            ...
            var attrs = at(attributes)
                .id(id)
                .at(DOM.Attribute.title, tip, DOM.Attribute.rel, getRel(), DOM.Attribute.name, getName(), DOM.Attribute.style, getStyle(), DOM.Attribute.target, getTarget())
                .at(!usePost, DOM.Attribute.href, StringUtils.defaultIfBlank(this.href,  "#"), "#")
            ...
            return createHtmlFragment(
                isSubmit() ?
                INPUT(at(type,"submit", DOM.Attribute.tabindex,"-1", DOM.Attribute.style,"position:absolute;left:-9999px;width:1px;height:1px;", DOM.Attribute.id,submitId)) : null,
