...
public class SubstitutionFormat
{
    ...
    public static SampleCountSubstitutionFormat sampleCount = new SampleCountSubstitutionFormat("sampleCount", NameGenerator.SubstitutionValue.sampleCount.getPreviewValue());
