...
public class SvgUtil
{
    ...
    public static @Nullable Size readSizeAttribute(String svg, String attribute)
    {
        ...
        if (value != null)
        {
            ...
            ret = new Size(Float.parseFloat(value), units);
        }
    ...
    private static final String svg = """
        ...
        (DRT2)</title><polygon id="line_6_polygonhead" fill="#000000" stroke="#000000" points="1061.748812220436,389.05043661239836 1074.2010200785408,380.3704297311479 1076.9185826356702,389.5777558222608 1061.748812220436,389.05043661239836"></polygon><text id="line_6_text_0" x="1570.3046637403095" y="268.40927466438677" text-anchor="middle" font-size="24.0" fill="#000000" font-family="Arial">SearchConfig</text></g></g></svg>""";
