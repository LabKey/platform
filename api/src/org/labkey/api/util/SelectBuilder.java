...
public class SelectBuilder extends InputBuilder<SelectBuilder>
{
    private final List<OptionBuilder.Option> _options = new ArrayList<>();
    ...
    public static class Select extends Input
    {
        private final boolean _multiple;
        private final List<OptionBuilder.Option> _options;
        ...
        public @NotNull List<OptionBuilder.Option> getOptions()
        {
            return _options;
        }
        ...
        {
            var id = StringUtils.defaultIfBlank(getId(), generateId("select"));

            sb.append("<select").append(" id=\"").append(h(id)).append("\" name=\"").append(hname(getName())).append("\"");
        ...
        {
            for (OptionBuilder.Option o : getOptions())
            {
                if (o != null)
                {
