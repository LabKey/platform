...
public class GUID implements Serializable, Parameter.JdbcParameterValue, SafeToRender
{
    ...
    /**
     * return an unpredictable unique string, using MD5 to produce a 128 bit result encoded as hexadecimal characters
     */
   ...
   public static String makeHash(String addl)
     ...
     */
    public static String makeSHA256Hash()
    {
        return makeSHA256Hash("");
    }

    /**
     * Keep in sync with looksLikeAValidSHA256Hash() below
     */
    public static String makeSHA256Hash(String addl)
    {
    ...
    /**
     * Does the supplied hash appear to have been generated by makeHash() above?
     */
    public static boolean looksLikeAValidSHA256Hash(String hash)
    {
        return hash.length() == 64 && StringUtils.containsOnly(hash,"0123456789abcdef");
    }
