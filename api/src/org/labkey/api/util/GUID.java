...
public class GUID implements Serializable, Parameter.JdbcParameterValue, SafeToRender
{
   ...
   public static String makeHash(String addl)
    ...
    /**
     * Keep in sync with looksLikeAValidLongHash() below
     */
    ...
    /**
     * Does the supplied hash appear to have been generated by makeLongHash() above?
     */
    public static boolean looksLikeAValidLongHash(String hash)
    {
