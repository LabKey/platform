...
public class InputBuilder<T extends InputBuilder<T>> implements HasHtmlString, SafeToRender// TODO: extends DisplayElementBuilder?
{
    ...
    public static InputBuilder<?> checkbox()
    {
        return new InputBuilder<>().type("checkbox");
    }

    public static InputBuilder<?> file()
    {
        return new InputBuilder<>().type("file");
    }

    public static InputBuilder<?> hidden()
    {
        return new InputBuilder<>().type("hidden");
    }

    public static InputBuilder<?> radio()
    {
        return new InputBuilder<>().type("radio");
    }

    public static InputBuilder<?> text()
    {
        return new InputBuilder<>(); // "text" is the default type
    }
    ...
    public T layout(Input.Layout layout)
    {
        _layout = layout;
        return (T) this;
    }
    ...
    public T state(Input.State state)
    {
        _state = state;
        return (T) this;
    }
    ...
    public static class Input extends DisplayElement implements HasHtmlString, SafeToRender
    {
        public enum Layout
        {
            HORIZONTAL,
        ...
        private final List<DataAttribute> _dataAttributes;
        ...
        private List<DataAttribute> getDataAttributes()
        {
