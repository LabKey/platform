...
public abstract class ProductMenuProvider
{
    ...
    @Nullable
    public abstract MenuSection getSection(@NotNull ViewContext context, @NotNull String sectionName, @NotNull Map<ExperimentService.DataTypeForExclusion, Set<Long>> dataTypeExclusions);

    @NotNull
    public List<MenuSection> getSections(@NotNull ViewContext context, @NotNull Collection<String> sectionNames, @NotNull Map<ExperimentService.DataTypeForExclusion, Set<Long>> dataTypeExclusions)
    {
    ...
    @NotNull
    public List<MenuSection> getSections(@NotNull ViewContext context, @NotNull Map<ExperimentService.DataTypeForExclusion, Set<Long>> dataTypeExclusions)
    {
