...
public abstract class AutoCompleteTag extends SimpleTagBase
{
    ...
    public void doTag() throws IOException
    {
        ...
        String sb = "<script type=\"text/javascript\" nonce=\"" + HttpView.currentPageConfig().getScriptNonce() + "\">\n" +
                ...
                "                completionUrl: " + PageFlowUtil.jsString(getUrl().getLocalURIString()) + ",\n" +
                getTagConfig(StringUtils.repeat(' ', 16)) +
                "            })\n" +
                "        })\n" +
                "    });\n" +
                "</script>\n" +
