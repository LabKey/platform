 ...
 * Cloned from https://github.com/penggle/kaptcha/blob/master/src/main/java/com/google/code/kaptcha/servlet/KaptchaServlet.java
 * and adapted for javax -> jakarta namespace
 *
...
public class LabKeyKaptchaServlet extends HttpServlet implements Servlet
{
            ...
            throws ServletException, IOException
    {
        ...
        req.getSession().setAttribute(this.SESSION_KEY_VALUE, capText);
