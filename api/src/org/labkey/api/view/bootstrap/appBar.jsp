...
<%@ page import="org.labkey.api.view.bootstrap.AppBarView" %>
...
//                                classes = classes + " tab-nav-no-menu"
                                        ;
                %>
                        <li role="presentation" class="<%=text(classes)%>">
                ...
                <%
                    ...
                    {
                %>
                        <li role="presentation" id="addTab">
                            <a href="javascript:LABKEY.Portal.addTab();" title="Add New Tab">+</a>
                        </li>
                        <li role="presentation" id="editTabs">
