 ...
 * admin-configured allow list. This should be used only in cases where we know the URL is safe for redirection, for
 * example, a trusted user has configured a URL that is used to redirect. Always add a comment explaining why bypassing
 * the allow list is safe.
 */
