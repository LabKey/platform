...
<table id="menubar"><tr>
    <td colspan=2 class="<%=menuBarClass%>"><span class="normal"><%
        ...
        {
    %>
            <a href="#" id="menuBarFolder" class="labkey-header" style="position:relative;padding-right:1em"><span><img src="<%=currentContext.getContextPath()%>/ext-3.1.1/resources/images/default/tree/folder.gif" style="vertical-align:bottom" alt="Folders"></span></a><%
        }
        if (menus.size() > 0)
        {
