...
public class SubfolderWriter extends BaseFolderWriter
{
    ...
    public void getChildrenToExport(FolderExportContext context, List<Container> potentialChildren, List<Container> childrenToExport)
    {
        for (Container child : potentialChildren)
        {
            if (child.includeForImportExport(context))
