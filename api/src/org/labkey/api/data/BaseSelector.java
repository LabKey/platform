...
public abstract class BaseSelector<SELECTOR extends BaseSelector> extends JdbcCommand<SELECTOR> implements Selector
{
    ...
    public void forEachMapBatch(ForEachBatchBlock<Map<String, Object>> batchBlock, int batchSize)
    {
        ...
        {
            // Ideally, we'd re-use the factory generated by forEachMap()... but we don't have access to it. This should be equivalent, though.
            getStandardResultSetFactory().handleSqlException(e, null);
        }
    }
    ...
    public <T> void forEachBatch(ForEachBatchBlock<T> batchBlock, Class<T> clazz, int batchSize)
    {
        ...
        {
            // Ideally, we'd re-use the factory generated by forEach()... but we don't have access to it. This should be equivalent, though.
            getStandardResultSetFactory().handleSqlException(e, null);
        }
    }
