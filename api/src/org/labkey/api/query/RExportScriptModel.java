...
public class RExportScriptModel extends ExportScriptModel
{
    ...
    public String getScriptExportText()
    {
        ...
        sb.append("## R Script generated by " + getInstallationName() + " on " + getCreatedOn()).append("\n");
        sb.append("#").append("\n");
        ...
        sb.append(indent).append("queryName=" + doubleQuote(getQueryName()) + ",").append("\n");
        sb.append(indent).append("viewName=" + doubleQuote(getViewName()) + ",").append("\n");
