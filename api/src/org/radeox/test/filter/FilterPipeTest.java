...
public class FilterPipeTest {
  ...
  public void testReplace() {
    ...
    Assert.assertEquals("MockReplacedFilter is removed from FilterPipe", -1, fp.index("org.radeox.test.filter.mock.MockReplacedFilter"));
    Assert.assertTrue("MockReplacesFilter is not removed from FilterPipe", -1 != fp.index("org.radeox.test.filter.mock.MockReplacesFilter"));
  }
}
