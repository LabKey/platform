...
/*
    NOTE: This is the standard JspWriter abstract class that ships with Tomcat (10.1.18). Compiling it with the LabKey
...
public abstract class JspWriter extends java.io.Writer {
     ...
     *
     * Note that some modules may bind to the "real" JspWriter residing in tomcat-jsp-api-10.1.18.jar, in which case some
     ...
     * tomcat-jsp-api-10.1.18.jar and tomcat-jsp-api-10.1.18-sources.jar, and excise JspWriter.class and JspWriter.java from
     * those jar files.
     */
