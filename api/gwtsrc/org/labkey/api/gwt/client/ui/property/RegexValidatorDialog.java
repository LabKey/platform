...
public class RegexValidatorDialog extends ValidatorDialog
{
    ...
    private void createPanel()
    {
        ...
        expressionLabel.add(new HelpPopup("Regular Expression", "The regular expression that this field's value will be evaluated against. " +
                "All regular expressions must be compatible with Java regular expressions as implemented in the <a target=\"_blank\" href=\"" + FormatItem.REGEX_PATTERN_DOCUMENTATION_LINK + "\"><code>Pattern</code></a> class."));
