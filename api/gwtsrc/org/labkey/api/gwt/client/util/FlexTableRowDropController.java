 ...
 * Date: Aug 25, 2010
 */
public abstract class FlexTableRowDropController extends AbstractPositioningDropController
{
    private static final String CSS_DEMO_TABLE_POSITIONER = "drag-target-table-positioner";
    ...
    public void onDrop(DragContext context)
    {
        ...
        FlexTable sourceTable = trDragController.getDraggableTable();
        int sourceRow = trDragController.getDragRow();
        handleDrop(sourceTable, flexTable, sourceRow, targetRow);
        super.onDrop(context);
    }

    protected abstract void handleDrop(FlexTable sourceTable, FlexTable targetTable, int sourceRow, int targetRow);
