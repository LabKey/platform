...
Ext4.Compat = function(){
    ...
    showMsg = function(msg, method, single){
        var isNew = Ext4.Array.indexOf(notificationCache, msg) == -1;
        if (isNew || !single) {
            Ext4.Compat[method](msg);
            if (single) {
    ...
    consoleOut = function(type, msg){
        if (Ext4.Compat.silent === true) {
            return;
        }
        if (!Ext4.isDefined(Ext4.global.console)){
            if (type === 'error' && Ext4.Array.indexOf(notificationCache, '__consoleMsg') == -1) {
        ...
        var con = Ext4.global.console;
        
        if(Ext4.Array.indexOf(notificationCache, '__initMsg') == -1){
        ...
        con[Ext4.Compat.showErrors ? 'error' : type](msg);
    };
        ...
        notify: function(o) {
            ...
            if(o.msg){
                var msg = getMsg(o, o.tag || 'INFO'),
                    single = Ext4.isDefined(o.single) ? o.single : !this.showErrors;
...
(function(){
    var compat = Ext4.Compat,
        ...
        bindProperty = Ext4.bind(compat.bindProperty, compat);
    ...
    Ext4.apply(Ext4, {
        createDelegate: function() {
            ...
            return Ext4.Function.bind.apply(Ext4.Function, arguments);
        },
        createCallback: function() {
            deprecate({pkg:'Ext', member:'createCallback', alt:'Ext.pass'});
            return Ext4.Function.pass.apply(Ext4.Function, arguments);
        },
        createInterceptor: function() {
            deprecate({pkg:'Ext', member:'createInterceptor', alt:'Ext.Function.createInterceptor'});
            return Ext4.Function.createInterceptor.apply(Ext4.Function, arguments);
        },
        createSequence: function() {
            deprecate({pkg:'Ext', member:'createSequence', alt:'Ext.Function.createSequence'});
            return Ext4.Function.createSequence.apply(Ext4.Function, arguments);
        },
...
//        },
        pluck: function(arr, prop) {
            ...
            return Ext4.Array.pluck.apply(Ext4.Array, arguments);
        }
...
//        }
     ...
     * Ext properties
     *-------------------------------------------------------------*/
    var versionObj = Ext4.getVersion('extjs');
...
//    });
    ...
    var aliasDom = function(name, args){
        ...
        return Ext4.core.Element[name].apply(Ext4.core.Element, args);
    };
    Ext4.lib = {};
    Ext4.lib.Dom = {
     ...
     * Ext.lib.Point
     *-------------------------------------------------------------*/
    Ext4.lib.Point = function(x, y) {
        deprecate({pkg:'Ext.lib.Point', alt:'Ext.util.Point'});
        return new Ext4.util.Point(x, y);
    };
    ...
    Ext4.lib.Ajax = {
        ...
        serializeForm : function(form) {
            ...
            return Ext4.core.Element.serializeForm(form);
        },
        abort : function() {
    ...
    Ext4.apply(Function.prototype, {
        createInterceptor : function(){
            ...
            return Ext4.Function.createInterceptor.apply(Ext4.Function, [this].concat(Array.prototype.slice.call(arguments)));
        },
        ...
        createCallback : function(){
            deprecate({pkg:'Function', member:'<fn>.createCallback', alt:'Ext.pass',
                msg:'Note that this is now a static method, so the function will be the first argument to the new version.'});
            return Ext4.pass.apply(Ext4.Function, [this].concat(Array.prototype.slice.call(arguments)));
        },
    
        createDelegate : function(obj, args, appendArgs){
            deprecate({pkg:'Function', member:'<fn>.createDelegate', alt:'Ext.bind',
                msg:'Note that this is now a static method, so the function will be the first argument to the new version.'});
            return Ext4.bind.apply(Ext4.Function, [this].concat(Array.prototype.slice.call(arguments)));
        },
        
        defer : function(){
            deprecate({pkg:'Function', member:'<fn>.defer', alt:'Ext.defer',
                msg:'Note that this is now a static method, so the function will be the first argument to the new version.'});
            return Ext4.defer.apply(Ext4.Function, [this].concat(Array.prototype.slice.call(arguments)));
        }
    });
    ...
    Ext4.applyIf(String, {
        format : function(){
            ...
            return Ext4.String.format.apply(Ext4.String, arguments);
        },
        escape : function(string) {
            deprecate({pkg:'String', member:'escape', alt:'Ext.String.escape'});
            return Ext4.String.escape.apply(Ext4.String, arguments);
        },
        leftPad : function (val, size, ch) {
            deprecate({pkg:'String', member:'leftPad', alt:'Ext.String.leftPad'});
            return Ext4.String.leftPad.apply(Ext4.String, arguments);
        }
    });
    // String instance methods:
    Ext4.applyIf(String.prototype, {
        toggle : function(value, other){
            ...
            return Ext4.String.toggle.call(Ext4.String, this, value, other);
        },
        trim : function(){
            deprecate({pkg:'String', member:'<string>.trim', alt:'Ext.String.trim',
                msg:'Note that this is now a static method, so the string instance will be the first argument to the new version.'});
            return Ext4.String.trim.call(Ext4.String, this);
        }
    });
    ...
    Ext4.applyIf(Array.prototype, {
        indexOf : function(o){
            ...
            return Ext4.Array.indexOf.call(Ext4.Array, this, o);
        },
        remove : function(o){
            deprecate({pkg:'Array', member:'<array>.remove', alt:'Ext.Array.remove',
                msg:'Note that this is now a static method, so the array instance will be the first argument to the new version.'});
            return Ext4.Array.remove.call(Ext4.Array, this, o);
        }
    });
    ...
    Ext4.applyIf(Number.prototype, {
        constrain : function(min, max){
            ...
            return Ext4.Number.constrain.call(Ext4.Number, this, min, max);
        }
    });
    ...
    Ext4.applyIf(Date.prototype, {
        ...
        getElapsed : function(date) {
            ...
            return Ext4.Date.getElapsed.call(Ext4.Date, this, date);
        }
    });
     ...
     * Element
     *-------------------------------------------------------------*/
    Ext4.apply(Ext4.core.Element.prototype, {
        getMargins : function(){
...
//        },
        animate: function(args, duration, onComplete, easing) {
            if (arguments.length > 1 || Ext4.isEmpty(args)) {
            ...
            if (Ext4.fx.Manager.hasFxBlock(me.id)) {
                return me;
            }
            args = args || {};
            if (duration) {
            ...
            Ext4.fx.Manager.queueFx(Ext4.create('Ext.fx.Anim', me.anim(args)));
            return this;
        },
        anim: Ext4.Function.createInterceptor(Ext4.core.Element.prototype.anim, function(config) {
     ...
     * Ajax
     *-------------------------------------------------------------*/
    Ext4.Ajax.serializeForm = function(form) {
