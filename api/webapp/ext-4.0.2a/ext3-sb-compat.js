...
Ext4.toolbar.Toolbar.SplitButton = Ext4.button.Split;

// DomHelper does not currently go through the ClassManager so there is no alternateClassName
Ext4.DomHelper = Ext4.core.DomHelper;

Ext4.apply(Ext4.panel.Panel.prototype, {
...
Ext4.apply(Ext4.menu.Menu.prototype, {
    addSeparator : function() {
        return this.add(Ext4.create('Ext.menu.Separator'));
    },
    addElement : function(el) {
        return this.add(Ext4.create('Ext.menu.Item', {
            el: el
        }));
    },
...
(function(){
    var compat = Ext4.Compat,
        deprecate = Ext4.bind(compat.deprecate, compat),
        notify = Ext4.bind(compat.notify, compat),
        breaking = Ext4.bind(compat.breaking, compat);
    ...
    (function(){
        ...
        Ext4.Array.forEach(staticMappings, function(member) {
        ...
        Ext4.Array.forEach(staticOverrides, function(member) {
        ...
        Ext4.Array.forEach(proto, function(member) {
     ...
     * XTypes
     *-------------------------------------------------------------*/
    if (Ext4.ClassManager) {
        Ext4.apply(Ext4.ClassManager, {
            instantiateByAlias: Ext4.Function.createInterceptor(Ext4.ClassManager.instantiateByAlias, function() {
                var args = Ext4.Array.toArray(arguments),
                    alias = args.shift();
                //
                ...
                if(alias == 'widget.tbsplit'){
                    ...
                    Ext4.ClassManager.setAlias('Ext.button.Split', 'widget.tbsplit');
                }
                if(alias == 'widget.progress'){
                    deprecate({pkg:'Core', member:'progress', alt:'progressbar', type:'xtype'});
                    Ext4.ClassManager.setAlias('Ext.ProgressBar', 'widget.progress');
                }
            })
        });
    }
     ...
     * MicedCollection
     *-------------------------------------------------------------*/
    if (Ext4.util.AbstractMixedCollection) {
        Ext4.apply(Ext4.util.AbstractMixedCollection.prototype, {
            removeKey : function() {
    ...
    if (Ext4.util.MixedCollection) {
        Ext4.apply(Ext4.util.MixedCollection.prototype, {
            constructor: Ext4.Function.createInterceptor(Ext4.util.MixedCollection.prototype.constructor, function() {
     ...
     * AbstractComponent
     *-------------------------------------------------------------*/
    if (Ext4.AbstractComponent) {
        Ext4.apply(Ext4.AbstractComponent.prototype, {
            addClass : function() {
     ...
     *-------------------------------------------------------------*/
    if (Ext4.Component) {
        Ext4.apply(Ext4.Component.prototype, {
            initComponent: Ext4.Function.createInterceptor(Ext4.Component.prototype.initComponent, function() {
                if(Ext4.isDefined(this.applyTo)){
                    ...
                    var replaced = false;
                    try{
                        var target = Ext4.get(this.applyTo);
                        if (target) {
    ...
    if (Ext4.ComponentManager) {
        ...
        Ext4.ComponentManager.registerType = function(xtype, cls){
            deprecate({pkg:'ComponentManager', member:'registerType', msg:Ext4.String.format(regMsg, 'widget.'+xtype)});
            checkClassRef('ComponentManager', cls, 'registerType');
            Ext4.ClassManager.setAlias(cls, 'widget.'+xtype);
        };
        Ext4.reg = function(xtype, cls){
            deprecate({pkg:'Ext', member:'reg', msg:Ext4.String.format(regMsg, 'widget.'+xtype)});
            checkClassRef('Ext', cls, 'reg');
            Ext4.ClassManager.setAlias(cls, 'widget.'+xtype);
        };
        Ext4.ComponentManager.registerPlugin = function(ptype, cls){
            deprecate({pkg:'ComponentManager', member:'registerPlugin', msg:Ext4.String.format(regMsg, 'plugin.'+ptype)});
            checkClassRef('ComponentManager', cls, 'registerPlugin');
            Ext4.ClassManager.setAlias(cls, 'plugin.'+ptype);
        };
        Ext4.preg = function(ptype, cls){
            deprecate({pkg:'Ext', member:'preg', msg:Ext4.String.format(regMsg, 'plugin.'+ptype)});
     ...
     * Container
     *-------------------------------------------------------------*/
    if (Ext4.container.AbstractContainer) {
        Ext4.apply(Ext4.container.AbstractContainer.prototype, {
            get: function(comp) {
    ...
    if (Ext4.container.Container) {
        Ext4.apply(Ext4.container.Container.prototype, {
            initComponent: Ext4.Function.createInterceptor(Ext4.container.Container.prototype.initComponent, function() {
                if (this.layout === 'form') {
     ...
     * Toolbar
     *-------------------------------------------------------------*/
    if (Ext4.toolbar.Toolbar) {
        Ext4.apply(Ext4.toolbar.Toolbar.prototype, {
    ...
    if (Ext4.toolbar.Paging) {
        Ext4.apply(Ext4.toolbar.Paging.prototype, {
            constructor: Ext4.Function.createInterceptor(Ext4.toolbar.Paging.prototype.constructor, function(config) {
     ...
     * Views
     *-------------------------------------------------------------*/
    if (Ext4.view.AbstractView) {
        Ext4.apply(Ext4.view.AbstractView.prototype, {
            initComponent : function(){
                var isDef = Ext4.isDefined;
                ...
                Ext4.view.AbstractView.superclass.initComponent.call(this);
                if(Ext4.isString(this.tpl) || Ext4.isArray(this.tpl)){
                    this.tpl = new Ext4.XTemplate(this.tpl);
                }
                ...
                this.all = new Ext4.CompositeElementLite();
     ...
     *-------------------------------------------------------------*/
    if (Ext4.panel.Panel) {
        Ext4.apply(Ext4.panel.AbstractPanel.prototype, {
            initComponent: Ext4.Function.createInterceptor(Ext4.panel.AbstractPanel.prototype.initComponent, function() {
                if (this.bodyCssClass) {
                    var me = this,
                        msg = '',
                        bodyCssClass = me.bodyCssClass;
                        
                    if (Ext4.isFunction(bodyCssClass)) {
     ...
     * Layouts
     *-------------------------------------------------------------*/
    if (Ext4.layout.container.Accordion) {
        Ext4.apply(Ext4.layout.container.Accordion.prototype, {
            constructor: Ext4.Function.createSequence(Ext4.layout.container.Accordion.prototype.constructor, function() {
     ...
     *-------------------------------------------------------------*/
    if (Ext4.panel.Table) {
        Ext4.apply(Ext4.panel.Table.prototype, {
            initComponent: Ext4.Function.createInterceptor(Ext4.panel.Table.prototype.initComponent, function() {
                if (Ext4.isDefined(this.preventHeaders)) {
     ...
     *-------------------------------------------------------------*/
    if (Ext4.grid.Panel) {
        Ext4.apply(Ext4.grid.Panel.prototype, {
            constructor: Ext4.Function.createInterceptor(Ext4.grid.Panel.prototype.constructor, function(config) {
                ...
                if (cols && Ext4.isArray(cols)) {
                    Ext4.each(cols, function(col) {
                ...
                if (config.store && config.store instanceof Ext4.data.GroupingStore) {
                    ...
                    config.features.push(Ext4.create('Ext.grid.feature.Grouping'));
                }
            }),
            
            initComponent: Ext4.Function.createInterceptor(Ext4.grid.Panel.prototype.initComponent, function() {
                if (this.autoExpandColumn !== undefined) {
                    ...
                    var id;
                    Ext4.Array.each(this.headers, function(header){
        ...
        Ext4.apply(Ext4.grid.GridPanel.prototype, {
            getColumnModel: function(){
                if (!this.colModel && !this.cm) {
                    this.cm = this.colModel = new Ext4.grid.ColumnModel({
        ...
        Ext4.grid.EditorGridPanel = function(config) {
            ...
            return Ext4.createWidget('grid', Ext4.apply(config || {}, {
    ...
    if (Ext4.grid.View) {
        Ext4.apply(Ext4.grid.View.prototype, {
            constructor: Ext4.Function.createInterceptor(Ext4.grid.View.prototype.constructor, function(config) {
                if(Ext4.isFunction(config.getRowClass)){
                    var getRowClass = config.getRowClass;
                    this.__getRowClass = Ext4.bind(getRowClass, this);
        ...
        Ext4.grid.GroupingView = function(config) {
    ...
    if (Ext4.grid.header.Container) {
        Ext4.apply(Ext4.grid.header.Container.prototype, {
            constructor: Ext4.Function.createSequence(Ext4.grid.header.Container.prototype.constructor, function() {
    ...
    if (Ext4.grid.Header) {
        Ext4.apply(Ext4.grid.Header.prototype, {
            initComponent: Ext4.Function.createInterceptor(Ext4.grid.Header.prototype.initComponent, function() {
                if (Ext4.isDefined(this.header)) {
    ...
    Ext4.grid.ColumnModel = function(config) {
        return Ext4.applyIf(config.columns ? config.columns : config, {
            on: Ext4.emptyFn,
            addListener: Ext4.emptyFn,
            getColumnId: Ext4.emptyFn,
            getColumnAt: Ext4.emptyFn,
            setConfig: Ext4.emptyFn,
            getColumnById: Ext4.emptyFn,
            getIndexById: Ext4.emptyFn,
            moveColumn: Ext4.emptyFn,
            getColumnCount: Ext4.emptyFn,
            getColumnsBy: Ext4.emptyFn,
            isSortable: Ext4.emptyFn,
            isMenuDisabled: Ext4.emptyFn,
            getRenderer: Ext4.emptyFn,
            getRendererScope: Ext4.emptyFn,
            setRenderer: Ext4.emptyFn,
            getColumnWidth: Ext4.emptyFn,
            setColumnWidth: Ext4.emptyFn,
            getTotalWidth: Ext4.emptyFn,
            getColumnHeader: Ext4.emptyFn,
            setColumnHeader: Ext4.emptyFn,
            getColumnTooltip: Ext4.emptyFn,
            setColumnTooltip: Ext4.emptyFn,
            getDataIndex: Ext4.emptyFn,
            setDataIndex: Ext4.emptyFn,
            findColumnIndex: Ext4.emptyFn,
            isCellEditable: Ext4.emptyFn,
            getCellEditor: Ext4.emptyFn,
            setEditable: Ext4.emptyFn,
            isHidden: Ext4.emptyFn,
            isFixed: Ext4.emptyFn,
            isResizable: Ext4.emptyFn,
            setHidden: Ext4.emptyFn,
            setEditor: Ext4.emptyFn,
            destroy: Ext4.emptyFn,
            setState: Ext4.emptyFn
        });
    };
    
    if (Ext4.grid.Column) {
        Ext4.Compat.bindProperty({owner:Ext4.grid.Column, name:'types', defaultValue:{},
            getterMsg: function(){
    ...
    if (Ext4.selection.Model) {
        Ext4.apply(Ext4.selection.Model.prototype, {
     ...
     *-------------------------------------------------------------*/
    Ext4.tree.TreeNode = function(config){
        deprecate({pkg:'Ext4.tree.TreeNode', msg:'This class is no longer needed. The Tree now uses standard Records that get decorated '+
            'by the NodeInterface class in Ext 4.'});
        Ext4.apply(this, config);
    };
    Ext4.tree.AsyncTreeNode = function(config){
        deprecate({pkg:'Ext.tree.AsyncTreeNode', msg:'This class is no longer needed. Specify a TreeStore with an AjaxProxy instead.'});
        Ext4.apply(this, config);
    };
    Ext4.tree.AsyncTreeNode.prototype = {
        expand: function(){
            if (this.store) {
                this.store.load({
    ...
    Ext4.tree.TreeSorter = function(tree, config){
    ...
    Ext4.tree.TreeLoader = function(config){
     ...
     *-------------------------------------------------------------*/
    if (Ext4.tree.Panel) {
        Ext4.apply(Ext4.tree.Panel.prototype, {
            constructor: Ext4.Function.createInterceptor(Ext4.tree.Panel.prototype.constructor, function(config) {
                if (config.hlDrop) {
                ...
                if (Ext4.isDefined(config.enableDrag)) {
                ...
                if (Ext4.isDefined(config.enableDrop)) {
                ...
                if (Ext4.isDefined(config.enableDD)) {
                ...
                if (config.root && (config.root instanceof Ext4.tree.AsyncTreeNode || config.root.nodeType == 'async')) {
                    config.loader = this.loader;
                }
                this.applyCompatOptions();
            }),
            
            initComponent: Ext4.Function.createSequence(Ext4.tree.Panel.prototype.initComponent, function() {
            ...
            applyCompatOptions: function(){
                ...
                if (loader && (loader.url || loader.dataUrl || loader.proxy)) {
                    ...
                    this.store = new Ext4.data.TreeStore(storeConfig);
...
//                }
     ...
     * SelectionModel
     *-------------------------------------------------------------*/
    if (Ext4.selection.RowModel) {
        Ext4.apply(Ext4.selection.RowModel.prototype, {
            constructor: Ext4.Function.createSequence(Ext4.selection.RowModel.prototype.constructor, function() {
     ...
     * Window
     *-------------------------------------------------------------*/
    if (Ext4.window.Window) {
        Ext4.apply(Ext4.window.Window.prototype, {
            constructor: Ext4.Function.createInterceptor(Ext4.window.Window.prototype.constructor, function(config) {
     ...
     *-------------------------------------------------------------*/
    if (Ext4.form.Basic) {
        Ext4.apply(Ext4.form.Basic.prototype, {
            add: function() {
    ...
    if (Ext4.form.Panel) {
        Ext4.apply(Ext4.form.Panel.prototype, {
            monitorValid: false,
            monitorPoll: 200,
            
            initComponent: Ext4.Function.createInterceptor(Ext4.form.Panel.prototype.initComponent, function() {
                var me = this,
                    fieldDefaultsProps = {
                ...
                Ext4.iterate(fieldDefaultsProps, function(from, to) {
                    if (from in me) {
    ...
    if (Ext4.form.field.Base) {
        Ext4.apply(Ext4.form.field.Base.prototype, {
            initComponent: Ext4.Function.createInterceptor(Ext4.form.field.Base.prototype.initComponent, function() {
                ...
                var msgTarget = Ext4.form.Field.prototype.msgTarget;
                if (msgTarget && msgTarget !== 'qtip') {
                    ...
                    Ext4.form.field.Base.prototype.msgTarget = Ext4.form.Field.prototype.msgTarget;
                }
            })
        });
    }

    if (Ext4.form.field.Checkbox) {
        Ext4.apply(Ext4.form.field.Checkbox.prototype, {
            initComponent: Ext4.Function.createInterceptor(Ext4.form.field.Checkbox.prototype.initComponent, function() {
                this.addEvents(
                    /**
                     * @event check
            ...
            onChange: Ext4.Function.createInterceptor(Ext4.form.field.Checkbox.prototype.onChange, function(newVal, oldVal) {
                this.fireEvent('check', this, this.checked);
            })
        });
    }

    if (Ext4.form.CheckboxGroup) {
        var cbgSetValue = Ext4.form.CheckboxGroup.prototype.setValue;
    
        Ext4.apply(Ext4.form.CheckboxGroup.prototype, {
    
            initComponent: Ext4.Function.createInterceptor(Ext4.form.CheckboxGroup.prototype.initComponent, function() {
                var me = this,
                    items = me.items;
                ...
                if (items && items[0] && 'columnWidth' in items[0] && me.layout !== 'column') {
                    ...
                    me.layout = 'column';
                    Ext4.Array.forEach(items, function(column) {
                ...
                if (arguments.length === 1) {
                    ...
                    if (Ext4.isString(value)) {
                        ...
                        me.batchChanges(function() {
                            Ext4.each(value, function(val, idx){
                                if (Ext4.isObject(val) && val.setValue) { // array of checkbox components to be checked
                                    val.setValue(true);
                                }
     ...
     * CompositeField
     *-------------------------------------------------------------*/
    if (Ext4.form.FieldContainer) {
        Ext4.define('Ext.form.CompositeField', {
            ...
            initComponent: function() {
                ...
                this.defaults = Ext4.apply({}, this.defaults, this.baseDefaults);
    ...
    if (Ext4.form.field.ComboBox) {
        Ext4.apply(Ext4.form.field.ComboBox.prototype, {
            initComponent: Ext4.Function.createInterceptor(Ext4.form.field.ComboBox.prototype.initComponent, function() {
                var me = this,
                    isDef = Ext4.isDefined;
     ...
     * Slider
     *-------------------------------------------------------------*/
    if (Ext4.slider.Multi) {
        Ext4.apply(Ext4.slider.Multi.prototype, {
            initComponent: Ext4.Function.createInterceptor(Ext4.slider.Multi.prototype.initComponent, function() {
                if (this.plugins) {
                    Ext4.each(this.plugins, function(p){
                        if (p.getText) {
                            ...
                            Ext4.Array.remove(this.plugins, p);
                            return;
                        }
                    }, this); 
                }
     ...
     *-------------------------------------------------------------*/
    if (Ext4.data.Store) {
        Ext4.apply(Ext4.data.AbstractStore.prototype, {
            constructor: Ext4.Function.createInterceptor(Ext4.data.AbstractStore.prototype.constructor, function(config) {
...
//                            'Please see the header docs for Ext.data.Store for details on properly setting up your data components.'});
        ...
        Ext4.apply(Ext4.data.Store.prototype, {
            constructor: Ext4.Function.createInterceptor(Ext4.data.Store.prototype.constructor, function(config) {
                if (config.data && Ext4.isObject(config.data)) {
...
//                    }
            ...
            setDefaultSort : function(field, dir) {
                ...
                this.sorters = new Ext4.util.MixedCollection();
                this.sorters.add(new Ext4.util.Sorter({
                    property: field,
        ...
        Ext4.Compat.bindProperty({owner:Ext4.data.Store, name:'recordType',
            getter: function(){
                return this.model;
            },
            getterMsg: function(){
    ...
    if (Ext4.data.JsonStore) {
        // TODO: Move this override into the lib?
        Ext4.apply(Ext4.data.JsonStore.prototype, {
            constructor: function(config) {
                config = config || {};
                config.proxy = config.proxy || {};
                
                Ext4.applyIf(config.proxy, {
                    url   : config.url,
                    type  : 'ajax',
                    writer: 'json',
                    reader: new Ext4.data.JsonReader(config)
                });
                Ext4.data.JsonStore.superclass.constructor.call(this, config);
            }
        });
    }
    
    Ext4.data.GroupingStore = function(config) {
     ...
     *-------------------------------------------------------------*/
    if (Ext4.data.Record) {
        Ext4.data.Record.create = function(o){
            ...
            var f = Ext4.extend(Ext4.data.Record, {});
            var p = f.prototype;
            p.fields = new Ext4.util.MixedCollection(false, function(field){
                return field.name;
            });
            for(var i = 0, len = o.length; i < len; i++){
                p.fields.add(new Ext4.data.Field(o[i]));
            }
     ...
     * Readers
     *-------------------------------------------------------------*/
    if (Ext4.data.JsonReader) {
        Ext4.data.JsonReader.override({
    ...
    if (Ext4.data.Reader) {
        Ext4.apply(Ext4.data.Reader.prototype, {
            constructor: function(config, recordType) {
                ...
                if (config.model) {
                    this.model = Ext4.ModelManager.getModel(config.model);
                }
                else if (config.fields) {
                    this.model = Ext4.define('Ext.data.Store.ImplicitModel-' + Ext4.id(), {
                        extend: 'Ext.data.Model',
                        fields: config.fields
                    });
                }
...
//                }
    ...
    if (Ext4.data.XmlReader) {
        Ext4.apply(Ext4.data.XmlReader.prototype, {
            ...
            constructor: function(config, recordType) {
                ...
                Ext4.data.XmlReader.superclass.constructor.apply(this, arguments);
            }
        });
    }
     ...
     * Proxies
     *-------------------------------------------------------------*/
    if (Ext4.data.ServerProxy) {
        Ext4.apply(Ext4.data.ServerProxy.prototype, {
            getParams: Ext4.Function.createInterceptor(Ext4.data.ServerProxy.prototype.getParams, function(params, operation) {
                if (this.sortParam && operation.sorters && operation.sorters.length > 0) {
                    if (!this.simpleSortMode) {
                        this.simpleSortMode = true;
                        Ext4.Compat.warn('ServerProxy now supports multiple sort, so if any sort options are specified '+
    ...
    if (Ext4.data.MemoryProxy) {
        Ext4.apply(Ext4.data.MemoryProxy.prototype, {
            read: Ext4.Function.createInterceptor(Ext4.data.MemoryProxy.prototype.read, function(op, cb, scope) {
                if (this.doRequest) {
                    ...
                    this.doRequest(op.action, op.getRecords(), params, this.getReader(), function(result, options){
                        ...
                        op.setCompleted();
                        op.setSuccessful();
                        Ext4.callback(cb, scope || this, [op]);
                    }, scope);
     ...
     *-------------------------------------------------------------*/
    if (Ext4.data.Model) {
        Ext4.apply(Ext4.data.Model.prototype, {
            constructor: Ext4.Function.createInterceptor(Ext4.data.Model.prototype.constructor, function(data, id) {
                var newData = {};
            ...
            initComponent: Ext4.Function.createInterceptor(Ext4.data.Model.prototype.initComponent, function() {
     ...
     *-------------------------------------------------------------*/
    if (Ext4.data.Operation) {
        Ext4.apply(Ext4.data.Operation.prototype, {
     ...
     *-------------------------------------------------------------*/
    if (Ext4.tip.ToolTip) {
        Ext4.apply(Ext4.tip.ToolTip.prototype, {
    ...
    if (Ext4.TaskManager) {
        Ext4.TaskMgr = function() {
            deprecate({pkg:'Ext.TaskMgr', alt:'Ext.TaskManager'});
            return Ext4.TaskManager;
        }
        Ext4.TaskMgr.start = Ext4.TaskManager.start;
        Ext4.TaskMgr.stop = Ext4.TaskManager.stop;
        Ext4.TaskMgr.stopAll = Ext4.TaskManager.stopAll;
    }
...
//
Ext4.define('Ext.ux.PreviewPlugin', {
