            ...
            if (ct && ct.length) {
                ...
                if (hasOffset && hasTotal) {
                    ...
                    if (low <= this.totalRows && high <= this.totalRows) {
                        ofTotal = ' of ' + this.totalRows.toLocaleString();
                        ...
                        var showFirstID = LABKEY.Utils.id();
                        var showFirstElem = showFirst ?
                                '<li><a id="' + showFirstID + '" tabindex="0">Show first</a></li>'
                                : '<li aria-disabled="true" class="disabled"><a>Show first</a></li>';

                        var showLastID = LABKEY.Utils.id();
                        var showLastElem = showLast ?
                                '<li><a id="' + showLastID + '" tabindex="0">Show last</a></li>'
                                : '<li aria-disabled="true" class="disabled"><a>Show last</a></li>';

                        var paginationText = this.showPaginationCount ? low.toLocaleString() + ' - ' + high.toLocaleString() + ofTotal : low.toLocaleString() + ' - ' + high.toLocaleString();

                        // If modifying this ensure it is consistent with DOM generated by PopupMenu.java
                        var pagingId = LABKEY.Utils.id();
                        var elems = [
                            '<div id="'+ pagingId + '" class="lk-menu-drop dropdown paging-widget">',
