...
public class GroupConcatInstallationManager extends AbstractClrInstallationManager
{
    ...
    {
        return "Failure installing GROUP_CONCAT aggregate function. This function is required for optimal operation of this server. Contact LabKey if you need assistance installing this function, or see " + new HelpTopic("groupconcatinstall").getHelpTopicHref();
    }

    @Override
    protected String getUninstallationExceptionMsg()
    {
        return "Failure uninstalling the existing GROUP_CONCAT aggregate function, which means it can't be upgraded to the latest version. Contact LabKey if you need assistance installing the newest version of this function, or see " + new HelpTopic("groupconcatinstall").getHelpTopicHref();
    }
