 ...
 * Date: 4/17/13
 */
public class TestTaskFactory extends AbstractTaskFactory<AbstractTaskFactorySettings, TestTaskFactory>
{
    public TestTaskFactory()
    {
        super(TestTaskFactory.class);
    }

    public TestTaskFactory(Class namespaceClass)
    {
        super(namespaceClass);
    }

    public TestTaskFactory(Class namespaceClass, String name)
    {
