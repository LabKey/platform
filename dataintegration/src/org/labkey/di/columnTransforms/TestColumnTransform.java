 ...
 * Prepends the value of the "id" column of the source query to the value of the source column specified in the ETL xml
 */
public class TestColumnTransform extends AbstractColumnTransform
{
    ...
    {
        return getInputValue("id") + "_" + inputValue;
    }
}
