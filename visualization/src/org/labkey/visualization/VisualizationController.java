...
*/
    ...
    abstract class ExportSVGAction extends BaseViewAction
    {
        ...
        protected @NotNull String getSVGSource() throws Exception
        {
            ...
            if (StringUtils.isBlank(_svgSource))
            ...
            if (!_svgSource.contains("xmlns=\"" + SVGDOMImplementation.SVG_NAMESPACE_URI + "\"") && !_svgSource.contains("xmlns='" + SVGDOMImplementation.SVG_NAMESPACE_URI + "'"))
