...
<form action="pickReferrer.post" method="post">
    <table>
        <tr><td colspan="2">Enter an optional URL prefix (e.g., https://www.foo.org).  If an unauthorized user attempts to retrieve
        a protected page and the referring site starts with this prefix then the user's browser will redirect to the OpenSSO
        URL you've set.  Use this setting to cause links from a partner's site to automatically authenticate using OpenSSO.</td></tr>
