 ...
 */
public class OntologyListQueryUpdateService extends AbstractQueryUpdateService
{
    ListDefinition _list = null;

    public OntologyListQueryUpdateService(OntologyListTable queryTable, ListDefinition list)
    {
        super(queryTable);
        _list = list;
    }
    ...
    {
        throw new IllegalStateException("method not used by OntologyListQueryUpdateService");
    }
