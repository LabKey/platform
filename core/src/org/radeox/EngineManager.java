...
public class EngineManager  {
  private static final Logger log = LogManager.getLogger(EngineManager.class);

  public static final String DEFAULT = "radeox";
  private static Map<String, RenderEngine> availableEngines = new HashMap<>();


  static {
    Iterator<RenderEngine> iterator = Service.providers(RenderEngine.class);
  ...
  public static synchronized RenderEngine getInstance(String name) {
    ...
    return availableEngines.get(name);
  }
  ...
  public static synchronized RenderEngine getInstance() {
    ...
    return availableEngines.get(DEFAULT);
  }
}
