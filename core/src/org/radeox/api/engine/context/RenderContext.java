...
public interface RenderContext {
  String INPUT_BUNDLE_NAME = "RenderContext.input_bundle_name";
  String OUTPUT_BUNDLE_NAME = "RenderContext.output_bundle_name";
  String LANGUAGE_BUNDLE_NAME = "RenderContext.language_bundle_name";
  String LANGUAGE_LOCALE = "RenderContext.language_locale";
  String INPUT_LOCALE = "RenderContext.input_locale";
  String OUTPUT_LOCALE = "RenderContext.output_locale";
  String DEFAULT_FORMATTER = "RenderContext.default_formatter";
