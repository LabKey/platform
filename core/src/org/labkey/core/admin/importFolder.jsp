...
<%--<tr><td class="labkey-title-area-line"></td></tr>--%>
    <%--<tr><td>--%>
        ...
        <%--selete the template folder and click the "Create Folder From Template" button. From there, you will be given a set--%>
...
//        // TODO: this store doesn't properly sort the containers
...
//                columns: 'entityId,path',
//                sort: 'path',
//                autoLoad: true,
//                filterArray: [
//                    LABKEY.Filter.create('containerType', 'root', LABKEY.Filter.Types.NOT_EQUAL)
//                ]
//            })
