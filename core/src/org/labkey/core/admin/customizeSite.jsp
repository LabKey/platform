...
<tr>
    ...
    <td><input type="text" name="companyName" size="50" value="<%= h(appProps.getCompanyName()) %>"></td>
</tr>
<tr>
...
<tr>
    ...
    <td><input type="text" name="reportAProblemPath" size="50" value="<%= h(appProps.getUnsubstitutedReportAProblemPath()) %>"></td>
</tr>
<tr>
...
<tr>
    <td class="labkey-form-label">Callback password</td>
    <td><input type="text" name="callbackPassword" size="20" value="<%= h(appProps.getCallbackPassword()) %>"></td>
</tr>
<tr>
