...
<tr>
    ...
    <td>
        <input type="text" name="textColor" size="6" maxlength="6" value="<%=((null != selectedTheme) ? selectedTheme.getTextColor() : StringUtils.trimToEmpty(bean.form.getTextColor()))%>" <%=disabled%>>
        <% if (!isBuiltInTheme) { %>
...
<tr>
    ...
    <td>
        <input type="text" name="linkColor" size="6" maxlength="6" value="<%=((null != selectedTheme) ? selectedTheme.getLinkColor() : StringUtils.trimToEmpty(bean.form.getLinkColor()))%>" <%=disabled%>>
        <% if (!isBuiltInTheme) { %>
...
<tr>
    ...
    <td>
        <input type="text" name="gridColor" size="6" maxlength="6" value="<%=((null != selectedTheme) ? selectedTheme.getGridColor() : StringUtils.trimToEmpty(bean.form.getGridColor()))%>" <%=disabled%>>
        <% if (!isBuiltInTheme) { %>
...
<tr>
    ...
    <td>
        <input type="text" name="primaryBackgroundColor" size="6" maxlength="6" value="<%=((null != selectedTheme) ? selectedTheme.getPrimaryBackgroundColor() : StringUtils.trimToEmpty(bean.form.getPrimaryBackgroundColor()))%>" <%=disabled%>>
        <% if (!isBuiltInTheme) { %>
...
<tr>
    ...
    <td>
        <input type="text" name="secondaryBackgroundColor" size="6" maxlength="6" value="<%=((null != selectedTheme) ? selectedTheme.getSecondaryBackgroundColor() : StringUtils.trimToEmpty(bean.form.getSecondaryBackgroundColor()))%>" <%=disabled%>>
        <% if (!isBuiltInTheme) { %>
...
<tr>
    ...
    <td>
        <input type="text" name="borderTitleColor" size="6" maxlength="6" value="<%=((null != selectedTheme) ? selectedTheme.getBorderTitleColor() : StringUtils.trimToEmpty(bean.form.getBorderTitleColor()))%>" <%=disabled%>>
        <% if (!isBuiltInTheme) { %>
...
<tr>
    ...
    <td>
        <input type="text" name="webpartColor" size="6" maxlength="6" value="<%=((null != selectedTheme) ? selectedTheme.getWebPartColor() : StringUtils.trimToEmpty(bean.form.getWebpartColor()))%>" <%=disabled%>>
        <% if (!isBuiltInTheme) { %>
