...
function submitSystemMaintenance(taskName)
{
    if (taskName)
        document.forms['systemMaintenance'].taskName.value = taskName;
    else
        document.forms['systemMaintenance'].taskName.value = null;
...
{
    return !timeField.hasActiveError();
}
</script>
