...
<div class="panel panel-default">
    ...
    <div class="panel-body" style="max-width: 1000px;">
        <table>
            ...
            <tr>
                <td colspan="2">The following tasks are (typically) run every night to clear unused data, update database
                    statistics, perform nightly data refreshes, and generally keep this server running smoothly and quickly.
                    Log files and outputs generated by the tasks are written to the <%=link("@files directory of the site file root",
                    urlProvider(FileUrls.class).urlBegin(ContainerManager.getRoot())).clearClasses()%>. We recommend leaving all system
                    maintenance tasks enabled, but tasks can be disabled if absolutely necessary. See the LabKey documentation
                    for <%=helpLink("systemMaint", "more information.")%></td>
            </tr>
