...
<%
    ...
    {
        ActionURL createProjectUrl = urlProvider(AdminUrls.class).getCreateProjectURL(c.getStartURL(getUser()));
        ActionURL createFolderUrl = urlProvider(AdminUrls.class).getCreateFolderURL(c, c.getStartURL(getUser()));
