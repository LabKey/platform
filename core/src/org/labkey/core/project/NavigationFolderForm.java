 ...
 * Date: 4/10/13
 */
public class NavigationFolderForm
{
    ViewContext _portalContext;
    NavigationFolderTree _folderMenu;

    public NavigationFolderTree getFolderMenu()
    {
        return _folderMenu;
    }

    public void setFolderMenu(NavigationFolderTree folderMenu)
    {
