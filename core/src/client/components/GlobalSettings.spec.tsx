...
describe("<GlobalSettings/>", () => {
    ...
    test("Clicking a checkbox toggles the checkbox", () => {
        ...
        let props = {SelfRegistration: true, SelfServiceEmailChanges: true, AutoCreateAccounts: false, canEdit: true, checkGlobalAuthBox };
    ...
    test("view-only mode", () => {
        const props = {SelfRegistration: true, SelfServiceEmailChanges: true, AutoCreateAccounts: false, canEdit: false};
        const component = <GlobalSettings {...props} />;
