...
CREATE TABLE PropertySets
    ...
    CONSTRAINT PropertySet_PK PRIMARY KEY CLUSTERED ("Set"),
    CONSTRAINT PropertySet_AK UNIQUE (ObjectId, UserId, Category)
    )
...
CREATE TABLE Properties
    ...
    CONSTRAINT Properties_PK PRIMARY KEY CLUSTERED ("Set", Name)
    )
GO
...
CREATE TABLE PortalWebParts
	...
	CONSTRAINT PortalWebParts_PK PRIMARY KEY (PageId, [Index])
	)
GO