...
-- This script is an 11.3 hotfix, however, no special rollup handling is needed since the script is idempotent.

-- Rewrite the fn_dropifexists SCHEMA and DEFAULT options on SQL Server to use the 2005 system tables, #13762
