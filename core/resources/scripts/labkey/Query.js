...
LABKEY.Filter = require("./Filter").Filter;
...
LABKEY.Query = new function()
{
    ...
    return {
         ...
         * @param {Integer} [config.maxRows] The maximum number of rows to return from the server (defaults to returning 100,000 rows).
