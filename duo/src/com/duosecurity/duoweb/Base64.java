...
public class Base64 {
	 ...
	 *            Specified options
	 * @return The Base64-encoded object
	 * @see com.duosecurity.duoweb.Base64#GZIP
	 * @see com.duosecurity.duoweb.Base64#DO_BREAK_LINES
	 * @throws java.io.IOException
	 *             if there is an error
	 * @since 2.0
	 */
	...
	/**
	 * A {@link com.duosecurity.duoweb.Base64.OutputStream} will write data to another
	 * <tt>java.io.OutputStream</tt>, given in the constructor, and
	 * encode/decode to/from Base64 notation on the fly.
	 * 
	 * @see com.duosecurity.duoweb.Base64
	 * @since 1.3
	 */
	public static class OutputStream extends java.io.FilterOutputStream {
		...
		/**
		 * Constructs a {@link com.duosecurity.duoweb.Base64.OutputStream} in ENCODE mode.
		 * 
		 * @param out
		...
		/**
		 * Constructs a {@link com.duosecurity.duoweb.Base64.OutputStream} in either ENCODE or DECODE
		 * mode.
		 * <p>
		 * Valid options:
		 * 
		 ...
		 * @param options
		 *            Specified options.
		 * @see com.duosecurity.duoweb.Base64#ENCODE
		 * @see com.duosecurity.duoweb.Base64#DECODE
		 * @see com.duosecurity.duoweb.Base64#DO_BREAK_LINES
		 * @since 1.3
		 */
