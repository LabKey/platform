    ...
    ORIGINATING_SITE
    {
        ...
        public List<SpecimenRequestRequirement> generateRequirements(SpecimenRequest owner, SpecimenRequestRequirement defaultRequirement)
        {
            ...
            if (vials.size() > 0)
            {
                ...
                for (Vial vial : vials)
                {
                    LocationImpl originatingLocation = LocationManager.get().getOriginatingLocation(vial);
    ...
    PROVIDING_SITE
    {
        ...
        public List<SpecimenRequestRequirement> generateRequirements(SpecimenRequest owner, SpecimenRequestRequirement defaultRequirement)
        {
            ...
            if (vials.size() > 0)
            {
                ...
                for (Vial vial : vials)
                {
                    LocationImpl providingLocation = LocationManager.get().getCurrentLocation(vial);
