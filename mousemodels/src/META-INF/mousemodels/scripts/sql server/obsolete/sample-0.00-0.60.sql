...
CREATE TABLE Cage (
   ...
   container ENTITYID,
   litterId INT NOT NULL FOREIGN KEY REFERENCES Litter(litterId),
   modelId INT NOT NULL FOREIGN KEY REFERENCES MouseModel(modelId),
...
CREATE TABLE Mouse (
    ...
    toeNo int NOT NULL,
    modelId int FOREIGN KEY REFERENCES MouseModel(modelId),
    cageId int FOREIGN KEY REFERENCES Cage(cageId),
	Sex nvarchar (1)  NULL ,
...
CREATE TABLE Sample (
    ...
    OrganismId ENTITYID FOREIGN KEY REFERENCES Mouse(EntityId), -- What animal did this come from. UNDONE -- Joining to different organism types
...
CREATE TABLE Box (
    ...
    FreezerId int FOREIGN KEY REFERENCES Freezer(FreezerId),
    Shelf nvarchar(4),
    Rack nvarchar(4),
    Drawer nvarchar(4),
    BoxName nvarchar(25) NOT NULL,
...
CREATE TABLE Inventory (
    ...
    PreparationId int NOT NULL FOREIGN KEY REFERENCES SamplePreparation(PreparationId),
...
SELECT
    ...
    Mouse.EntityId mouseEntityId, Mouse.Container Container, Inventory.BoxId, DATEDIFF(week, Mouse.BirthDate, Sample.CollectionDate) Weeks
FROM Sample 
...
INSERT INTO SampleSource (SourceId, SourceName, CreatedBy, Created, ModifiedBy, Modified, Container) VALUES (@sampleSourceId, 'EDI Mouse Models', 1001, GETDATE(), 1001, GETDATE(), @lookupContainer)
